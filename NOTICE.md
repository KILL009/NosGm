...
GPLv3 obligations apply to the GPL-3.0-only components and to combined distributions when those terms govern the combination. MIT notices must remain with copies or substantial portions of the client-enhancement component.
...
The software is provided without warranty, to the extent permitted by applicable law. See the applicable GPL and MIT texts and `NOTICE.md` files for the complete terms.
