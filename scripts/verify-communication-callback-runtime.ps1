...
& (Join-Path $PSScriptRoot "verify-communication-callback-parity-comparator.ps1")
& (Join-Path $PSScriptRoot "verify-communication-callback-master-mirror.ps1")

Write-Host `
    "NosGM bounded callback runtime, generation lifecycle, replay barrier, parity comparator, production shadow, Master mirror and EventId contracts passed." `
