...
Require $collector 'Get-Content -LiteralPath $file.FullName -Tail $MaxLogLines' 'Log collection must be bounded to a tail.'
Require $collector '$MaxLogMegabytes * 1MB' 'Each sanitized log output must have a size ceiling.'
