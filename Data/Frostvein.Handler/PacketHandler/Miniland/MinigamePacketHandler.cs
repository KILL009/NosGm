                            ...
                            && packet.Point.HasValue && packet.Point >= 0)
                        {
                            if (GetMinilandMaxPoint(game)[packet.Point.Value] < Session.Character.MinigameLog.Score)
                            {
                                ...
                                if (obj != null)
                                {
                                    ...
                                    if (inv.Count == 0)
                                    {
                                        Session.Character.SendItem(Session.Character.CharacterId, obj.VNum, obj.Amount, 0, 0, 0, false);
                                    }
                    ...
                    case 8:
                        ...
                        for (int i = 0; i < 9; i++)
                        {
                            if (gifts.Count > i)
                            {
                                ...
                                {
                                    Session.Character.SendItem(Session.Character.CharacterId, itemVNum, itemAmount, 0, 0, 0, false);
                                }
