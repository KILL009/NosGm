...
using NosGm.Handler.PacketHandler.Command;
...
namespace NosGm.World
{
    public static class Program
    {
        ...
        {
            Console.Title = $"NosGm - World Server";
            const string text = @"
        ...
        portloop:
            ...
            if (newChannelId.HasValue)
            {
                ...
                if (ServerConfiguration.StartGlacernonAutomaticly)
                {
                    ...
                    {
                        Process.Start("NosGm.World.exe", $"--nomsg --port 5100");
                    }
                }
            ...
            Console.Title = $"NosGm - World Server [Channel {ServerManager.Instance.ChannelId} | {PlayerCountThread.PlayerCount} Players online]";
        }
