using NosGm.DAL.EF.Entities;
using System.Data.Entity;
using System.Data.Entity.ModelConfiguration.Conventions;

namespace NosGm.DAL.EF
{
    public class NosGmContext : DbContext
    {
        #region Instantiation

        public NosGmContext() : base("NosGmContext")
        {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Raidbox>()
                .HasRequired(e => e.OriginalItem)
                .WithMany(e => e.Raidbox)
        ...
        public virtual DbSet<BattlePassAccountLog> BattlePassAccountLog { get; set; }

        public virtual DbSet<BattlePassPrize> BattlePassPrize { get; set; }

        public virtual DbSet<BattlePassQuest> BattlePassQuest { get; set; }

        public virtual DbSet<BattlePassQuestProgress> BattlePassQuestProgress { get; set; }
        ...
        public virtual DbSet<CharacterFish> CharacterFish { get; set; }
        ...
        public virtual DbSet<FairyEnchantment> FairyEnchantment { get; set; }
        ...
        public virtual DbSet<FishingPosition> FishingPosition { get; set; }

        public virtual DbSet<FishingInformations> FishingInformations { get; set; }

        public virtual DbSet<Raidbox> Raidbox { get; set; }
