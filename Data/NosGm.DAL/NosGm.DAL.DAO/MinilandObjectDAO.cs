...
namespace NosGm.DAL.DAO
{
    public class MinilandObjectDAO : IMinilandObjectDAO
    {
        ...
        private static MinilandObjectDTO insert(MinilandObjectDTO obj, NosGmContext context)
        {
            try
            {
        ...
        private async Task<MinilandObjectDTO> InsertAsync(MinilandObjectDTO obj, NosGmContext context)
        {
            try
            {
                var entity = new MinilandObject();
        ...
        private async Task<MinilandObjectDTO> UpdateAsync(MinilandObject entity, MinilandObjectDTO respawn, NosGmContext context)
        {
            if (entity != null)
            {
                MinilandObjectMapper.ToMinilandObject(respawn, entity);
