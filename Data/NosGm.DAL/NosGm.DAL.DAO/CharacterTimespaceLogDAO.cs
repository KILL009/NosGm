...
namespace NosGm.DAL.DAO
{
    public class CharacterTimespaceLogDAO : ICharacterTimespaceLogDAO
    {
        ...
        private static CharacterTimespaceLogDTO insert(CharacterTimespaceLogDTO card, NosGmContext context)
        {
            var entity = new CharacterTimespaceLog();
        ...
        private static void update(CharacterTimespaceLog entity, CharacterTimespaceLogDTO card, NosGmContext context)
        {
