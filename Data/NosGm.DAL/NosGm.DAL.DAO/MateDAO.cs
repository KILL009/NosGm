...
namespace NosGm.DAL.DAO
{
    public class MateDAO : IMateDAO
    {
        ...
        private static MateDTO insert(MateDTO mate, NosGmContext context)
        {
            var entity = new Mate();
        ...
        private static MateDTO update(Mate entity, MateDTO character, NosGmContext context)
        {
            if (entity != null)
            {
        ...
        private async Task<MateDTO> UpdateAsync(Mate entity, MateDTO mate, NosGmContext context)
        {
            if (entity != null)
            {
                Mapper.Mappers.MateMapper.ToMate(mate, entity);
        ...
        private async Task<MateDTO> InsertAsync(MateDTO mate, NosGmContext context)
        {
