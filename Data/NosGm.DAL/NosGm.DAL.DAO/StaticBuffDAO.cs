...
namespace NosGm.DAL.DAO
{
    public class StaticBuffDAO : IStaticBuffDAO
    {
        ...
        private static StaticBuffDTO insert(StaticBuffDTO sb, NosGmContext context)
        {
            try
            {
        ...
        private static StaticBuffDTO update(StaticBuff entity, StaticBuffDTO sb, NosGmContext context)
        {
            if (entity != null)
            {
                StaticBuffMapper.ToStaticBuff(sb, entity);
        ...
        private async Task<StaticBuffDTO> InsertAsync (StaticBuffDTO sb, NosGmContext context)
        {
            try
            {
                var entity = new StaticBuff();
        ...
        private async Task<StaticBuffDTO> UpdateAsync (StaticBuff entity, StaticBuffDTO sb, NosGmContext context)
        {
            if (entity != null)
            {
                StaticBuffMapper.ToStaticBuff(sb, entity);
