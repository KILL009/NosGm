...
namespace NosGm.DAL.DAO
{
    public class FamilyLogDAO : IFamilyLogDAO
    {
        ...
        private static FamilyLogDTO insert(FamilyLogDTO famlog, NosGmContext context)
        {
        ...
        private static FamilyLogDTO update(FamilyLog entity, FamilyLogDTO famlog, NosGmContext context)
        {
            if (entity != null)
            {
                FamilyLogMapper.ToFamilyLog(famlog, entity);
