...
namespace NosGm.DAL.DAO
{
    ...
    public sealed class TradeCommitDAO
    {
        ...
        private static int AcquireOperationLock(NosGm.DAL.EF.NosGmContext context, Guid operationId)
        {
            const string sql = @"
DECLARE @Result int;
...
SELECT @Result;";
        ...
        private static bool HasSchema(NosGm.DAL.EF.NosGmContext context)
        {
        ...
        private static bool IsCompleted(NosGm.DAL.EF.NosGmContext context, Guid operationId)
        {
        ...
        private static void InsertOperation(NosGm.DAL.EF.NosGmContext context, TradeCommitDTO request)
        {
            const string sql = @"
