...
SELECT ISNULL(@MailId, CAST(0 AS BIGINT));";
        ...
        private static MailDTO LoadById(NosGmContext context, long mailId)
        {
        ...
        private static void EnrichDeliveryMetadata(NosGmContext context, MailDTO mail)
        {
...
END";
        ...
        private static MailDTO Insert(MailDTO mail, NosGmContext context)
        {
            try
            {
                var entity = new Mail();
        ...
        private static MailDTO Update(Mail entity, MailDTO mail, NosGmContext context)
        {
            if (entity != null)
            {
                MailMapper.ToMail(mail, entity);
