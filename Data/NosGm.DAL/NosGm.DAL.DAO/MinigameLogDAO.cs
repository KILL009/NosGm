...
namespace NosGm.DAL.DAO
{
    public class MinigameLogDAO : IMinigameLogDAO
    {
        ...
        private static MinigameLogDTO insert(MinigameLogDTO account, NosGmContext context)
        {
        ...
        private static MinigameLogDTO update(MinigameLog entity, MinigameLogDTO account, NosGmContext context)
        {
            if (entity != null)
            {
                MinigameLogMapper.ToMinigameLog(account, entity);
