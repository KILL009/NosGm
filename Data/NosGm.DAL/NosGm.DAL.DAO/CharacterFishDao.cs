...
namespace NosGm.DAL.DAO
{
    public class CharacterFishDao : ICharacterFishDao
    {
        ...
        private static CharacterFishDto insert(CharacterFishDto card, NosGmContext context)
        {
        ...
        private static CharacterFishDto update(CharacterFish entity, CharacterFishDto card, NosGmContext context)
        {
            if (entity != null)
            {
                Mapper.Mappers.CharacterFIshMapper.ToCharacterFish(card, entity);
        ...
        private static async Task<CharacterFishDto> InsertAsync(CharacterFishDto card, NosGmContext context)
        {
            var entity = new CharacterFish();
            Mapper.Mappers.CharacterFIshMapper.ToCharacterFish(card, entity);
            context.CharacterFish.Add(entity);
        ...
        private static async Task<CharacterFishDto> UpdateAsync(CharacterFish entity, CharacterFishDto card, NosGmContext context)
        {
            if (entity != null)
            {
                Mapper.Mappers.CharacterFIshMapper.ToCharacterFish(card, entity);
