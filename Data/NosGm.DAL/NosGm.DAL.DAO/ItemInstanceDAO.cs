...
namespace NosGm.DAL.DAO
{
    public class ItemInstanceDAO : IItemInstanceDAO
    {
                ...
                catch (Exception ex)
                {
                    ...
                    foreach (var id in enumerable)
                    {
                        ...
                        catch (Exception exc)
                        {
                            ...
                            // occurred in database "NosGm", table "dbo.BazaarItem", column 'ItemInstanceId'.
        ...
        protected static ItemInstanceDTO Insert(ItemInstanceDTO dto, NosGmContext context)
        {
        ...
        protected static ItemInstanceDTO InsertOrUpdate(NosGmContext context, ItemInstanceDTO dto)
        {
            try
            {
        ...
        protected static ItemInstanceDTO Update(ItemInstance entity, ItemInstanceDTO inventory, NosGmContext context)
        {
            if (entity != null)
            {
