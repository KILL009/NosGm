...
namespace NosGm.DAL.DAO
{
    public class FamilySkillMissionDAO : IFamilySkillMissionDAO
    {
        ...
        private static FamilySkillMissionDTO Insert(FamilySkillMissionDTO famskillmission, NosGmContext context)
        {
        ...
        private static FamilySkillMissionDTO Update(FamilySkillMission entity, FamilySkillMissionDTO famskillmission, NosGmContext context)
        {
            if (entity != null)
            {
                Mapper.Mappers.FamilySkillMissionMapper.ToFamilySkillMission(famskillmission, entity);
