...
namespace NosGm.DAL.DAO
{
    public class PenaltyLogDAO : IPenaltyLogDAO
    {
        ...
        private static PenaltyLogDTO insert(PenaltyLogDTO penaltylog, NosGmContext context)
        {
        ...
        private static PenaltyLogDTO update(PenaltyLog entity, PenaltyLogDTO penaltylog, NosGmContext context)
        {
            if (entity != null)
            {
                PenaltyLogMapper.ToPenaltyLog(penaltylog, entity);
