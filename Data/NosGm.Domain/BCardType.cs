namespace NosGm.Domain
{
    public static class BCardType
    {
        ...
        public enum CardType : byte
        {
            ...
            SealedLodDamage = 90,
            LotusSkills = 91,
            ElementalBonusDamage = 93,
            IncreaseResistanceByPercent = 94,
            ApplyBuffs = 95,
    ...
    public static class AdditionalTypes
    {
        ...
        {
            DodgeAttackAndGenerateBuff = 11,
            DodgeAttackAndGenerateBuffNegated = 12,
            ChangeMoonSkills = 31,
            ChangeLotusSkills = 41
        }

        public enum ElementalBonusDamage : byte
        {
            IncreaseFire = 11,
            DecreaseFire = 12,
            IcreaseWater = 21,
        ...
        public enum SummonSkill : byte
        {
            ...
            TransformToBear = 41,
            TransformToDruid = 42,
            CrusherDamagePercent = 51
        }

        public enum Transfo : byte
        {
            ToMorph = 31
        }
