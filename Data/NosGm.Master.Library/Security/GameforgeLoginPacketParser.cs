...
{
    /// <summary>
    /// Strict parser for the shared NoS0576/NoS0577 body observed in current clients.
    /// It preserves the two spaces before InstallationId and the vertical-tab byte
