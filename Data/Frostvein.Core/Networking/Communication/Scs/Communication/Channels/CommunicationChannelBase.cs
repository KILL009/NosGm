...
namespace Frostvein.Core.Networking.Communication.Scs.Communication.Channels
{
    /// <summary>
    ...
    public abstract class CommunicationChannelBase : ICommunicationChannel
    {
        ...
        protected abstract Task SendMessagePublicAsync(IScsMessage message, byte priority);
        ...
        public async Task SendMessageAsync(IScsMessage message, byte priority)
        {
            if (message == null)
            {
                throw new ArgumentNullException(nameof(message));
            }
            await SendMessagePublicAsync(message, priority).ConfigureAwait(false);
        }
