using Frostvein.Core.Networking.Communication.Scs.Communication.Protocols.BinarySerialization;

namespace Frostvein.Core.Networking.Communication.Scs.Communication.Protocols
{
    /// <summary>
