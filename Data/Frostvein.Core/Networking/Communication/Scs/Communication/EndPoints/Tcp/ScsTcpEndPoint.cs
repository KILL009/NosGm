...
using Frostvein.Core.Networking.Communication.Scs.Client.Tcp;
using Frostvein.Core.Networking.Communication.Scs.Server;
using Frostvein.Core.Networking.Communication.Scs.Server.Tcp;
using System;
using System.Net;
using System.Net.Sockets;

namespace Frostvein.Core.Networking.Communication.Scs.Communication.EndPoints.Tcp
{
    /// <summary>
