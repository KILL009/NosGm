...
namespace Frostvein.DAL.DAO
{
    public class QuicklistEntryDAO : IQuicklistEntryDAO
    {
        ...
        protected static QuicklistEntryDTO Insert(QuicklistEntryDTO dto, FrostveinContext context)
        {
        ...
        protected static QuicklistEntryDTO InsertOrUpdate(FrostveinContext context, QuicklistEntryDTO dto)
        {
        ...
        protected static async Task<QuicklistEntryDTO> InsertOrUpdateAsync(FrostveinContext context, QuicklistEntryDTO dto)
        {
        ...
        protected static async Task<QuicklistEntryDTO> UpdateAsync(QuicklistEntry entity, QuicklistEntryDTO inventory, FrostveinContext context)
        {
            if (entity != null)
            {
                QuicklistEntryMapper.ToQuicklistEntry(inventory, entity);
        ...
        protected static async Task<QuicklistEntryDTO> InsertAsync(QuicklistEntryDTO dto, FrostveinContext context)
        {
