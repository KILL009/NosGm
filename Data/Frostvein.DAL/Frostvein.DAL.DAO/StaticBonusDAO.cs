...
namespace Frostvein.DAL.DAO
{
    public class StaticBonusDAO : IStaticBonusDAO
    {
        ...
        private static StaticBonusDTO insert(StaticBonusDTO sb, FrostveinContext context)
        {
            try
            {
        ...
        private static StaticBonusDTO update(StaticBonus entity, StaticBonusDTO sb, FrostveinContext context)
        {
            if (entity != null)
            {
                StaticBonusMapper.ToStaticBonus(sb, entity);
        ...
        private async Task<StaticBonusDTO> InsertAsync (StaticBonusDTO sb, FrostveinContext context)
        {
            try
            {
                var entity = new StaticBonus();
        ...
        private async Task<StaticBonusDTO> UpdateAsync (StaticBonus entity, StaticBonusDTO sb, FrostveinContext context)
        {
            if (entity != null)
            {
                StaticBonusMapper.ToStaticBonus(sb, entity);
