...
namespace Frostvein.DAL.DAO
{
    public class CharacterDAO : ICharacterDAO
    {
        ...
        private static CharacterDTO Insert(CharacterDTO character, FrostveinContext context)
        {
        ...
        private static CharacterDTO Update(Character entity, CharacterDTO character, FrostveinContext context)
        {
            if (entity != null)
            {
                CharacterMapper.ToCharacter(character, entity);
        ...
        private async Task<CharacterDTO> UpdateAsync(Character entity, CharacterDTO character, FrostveinContext context)
        {
        ...
        private async Task<CharacterDTO> InsertAsync(CharacterDTO character, FrostveinContext context)
        {
