...
namespace Frostvein.DAL.DAO
{
    public class NpcMonsterDAO : INpcMonsterDAO
    {
        ...
        private static NpcMonsterDTO insert(NpcMonsterDTO npcMonster, FrostveinContext context)
        {
            var entity = new NpcMonster();
        ...
        private static NpcMonsterDTO update(NpcMonster entity, NpcMonsterDTO npcMonster, FrostveinContext context)
        {
            if (entity != null)
            {
                NpcMonsterMapper.ToNpcMonster(npcMonster, entity);
