...
namespace Frostvein.DAL.DAO
{
    public class FamilyDAO : IFamilyDAO
    {
        ...
        private static FamilyDTO insert(FamilyDTO family, FrostveinContext context)
        {
        ...
        private static FamilyDTO update(Family entity, FamilyDTO family, FrostveinContext context)
        {
            if (entity != null)
            {
                FamilyMapper.ToFamily(family, entity);
