...
namespace Frostvein.DAL.DAO
{
    public class ShellEffectDAO : IShellEffectDAO
    {
        ...
        private static ShellEffectDTO insert(ShellEffectDTO shelleffect, FrostveinContext context)
        {
        ...
        private static ShellEffectDTO update(ShellEffect entity, ShellEffectDTO shelleffect, FrostveinContext context)
        {
            if (entity != null)
            {
                ShellEffectMapper.ToShellEffect(shelleffect, entity);
