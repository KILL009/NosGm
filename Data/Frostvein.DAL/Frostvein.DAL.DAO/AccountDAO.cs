...
namespace Frostvein.DAL.DAO
{
    public class AccountDAO : IAccountDAO
    {
        ...
        private static AccountDTO insert(AccountDTO account, FrostveinContext context)
        {
            var entity = new Account();
            AccountMapper.ToAccount(account, entity);
            context.Account.Add(entity);
        ...
        private static AccountDTO update(Account entity, AccountDTO account, FrostveinContext context)
        {
            if (entity != null)
            {
                AccountMapper.ToAccount(account, entity);
