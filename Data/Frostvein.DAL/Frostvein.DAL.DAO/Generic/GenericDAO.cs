...
namespace Frostvein.DAL.DAO.Generic
{
    public class GenericDAO<TDTOEntity, TEntity> where TDTOEntity : class where TEntity : class
    {
        public TDTOEntity InsertOrUpdate(FrostveinContext context, TDTOEntity dtoEntity, DbSet<TEntity> contextList, IModuleMapper<TDTOEntity, TEntity> moduleMapper, Func<TEntity, bool> condition)
        {
            try
            {
        ...
        public void InsertOrUpdateFromList(FrostveinContext context, List<TDTOEntity> dtoEntityList, DbSet<TEntity> contextList, IModuleMapper<TDTOEntity, TEntity> moduleMapper, Func<TEntity, bool> condition)
        {
            try
            {
        ...
        private TDTOEntity Insert(TDTOEntity dtoEntity, DbSet<TEntity> contextList, IModuleMapper<TDTOEntity, TEntity> moduleMapper, FrostveinContext context)
        {
        ...
        private TDTOEntity Update(TEntity entity, TDTOEntity dtoEntity, IModuleMapper<TDTOEntity, TEntity> moduleMapper, FrostveinContext context)
        {
            if (entity != null)
            {
                moduleMapper.ToEntity(dtoEntity, entity);
