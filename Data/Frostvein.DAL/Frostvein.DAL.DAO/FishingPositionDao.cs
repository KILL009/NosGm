...
namespace Frostvein.DAL.DAO
{
    public class FishingPositionDao : IFishingPositionDao
    {
        ...
        private static FishingPositionDto insert(FishingPositionDto card, FrostveinContext context)
        {
        ...
        private static FishingPositionDto update(FishingPosition entity, FishingPositionDto card, FrostveinContext context)
        {
            if (entity != null)
            {
                Mapper.Mappers.FishingPositionMapper.ToFishingPosition(card, entity);
