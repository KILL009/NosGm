...
namespace Frostvein.DAL.DAO
{
    public class CharacterQuestDAO : ICharacterQuestDAO
    {
        ...
        protected static CharacterQuestDTO InsertOrUpdate(FrostveinContext context, CharacterQuestDTO dto)
        {
        ...
        private static CharacterQuestDTO Insert(CharacterQuestDTO charQuest, FrostveinContext context)
        {
