...
namespace Frostvein.DAL.DAO
{
    public class BazaarItemDAO : IBazaarItemDAO
    {
        ...
        private static BazaarItemDTO insert(BazaarItemDTO bazaarItem, FrostveinContext context)
        {
        ...
        private static BazaarItemDTO update(BazaarItem entity, BazaarItemDTO bazaarItem, FrostveinContext context)
        {
            if (entity != null)
            {
                BazaarItemMapper.ToBazaarItem(bazaarItem, entity);
