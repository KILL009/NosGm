...
namespace Frostvein.DAL.DAO
{
    public class QuestDAO : IQuestDAO
    {
        ...
        private static QuestDTO insert(QuestDTO quest, FrostveinContext context)
        {
            var entity = new Quest();
            QuestMapper.ToQuest(quest, entity);
            context.Quest.Add(entity);
        ...
        private static QuestDTO update(Quest entity, QuestDTO quest, FrostveinContext context)
        {
            if (entity != null)
            {
                QuestMapper.ToQuest(quest, entity);
