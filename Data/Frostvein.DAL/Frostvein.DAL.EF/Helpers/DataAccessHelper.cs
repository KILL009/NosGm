...
namespace Frostvein.DAL.EF.Helpers
{
    public static class DataAccessHelper
    {
        #region Members

        private static FrostveinContext _context;

        #endregion

        #region Properties

        private static FrostveinContext Context => _context ?? (_context = CreateContext());
        ...
        /// </summary>
        public static FrostveinContext CreateContext()
        {
            return new FrostveinContext();
        }
