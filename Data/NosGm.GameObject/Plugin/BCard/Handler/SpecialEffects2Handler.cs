...
{
    public class SpecialEffects2Handler : IBCardHandler
    {
        public BCardType.CardType ActionType => BCardType.CardType.SpecialEffects2;
        ...
        public void Execute(BCardEvent evnt)
        {
            ...
            {
                if (target.Character != null && target.MapEntityId == caster.MapEntityId)
                {
                    target.Character.TeleportToDir(target.Character.Direction, firstData);
                }
            }
        }
    }
