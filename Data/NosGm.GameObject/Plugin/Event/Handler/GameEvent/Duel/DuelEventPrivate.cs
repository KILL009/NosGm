...
{
    public static class DuelEventPrivate
    {
        private static readonly TimeSpan DuelTime = new(0, 5, 0);

        public static void PrivateSendInMapAfter(this MapInstance map, double sec, string packet)
        {
        ...
        public static void GenerateOneVersusOne()
        {
            ...
            var you = ServerManager.Instance.Sessions.Where(s => s.Character?.IsIn1v1PrivateQueue == true && s.Character.MapInstance.MapInstanceType == MapInstanceType.BaseMapInstance);
            ...
            foreach (var s in you)
            {
                ...
                if (i == 1)
                {
                    ...
                    s.Character.IsIn1v1PrivateQueue = false;
                    s.Character.IsCurrentlyIn1v1Private = true;
            ...
            ServerManager.Instance.StartedEvents.Remove(EventType.DUELEVENTPRIVATE);
            OneVersusOnePrivateTask.Run(map);
        }

        public class OneVersusOnePrivateTask
        {
            public static void Run(MapInstance mapinstance)
            {
                mapinstance.Sessions.Where(s => s.Character != null).ToList().ForEach(s =>
                {
                    ...
                    mapinstance.PrivateSendInMapAfter(10, "msg 0 The Duel will begin in 20 seconds.");
                    mapinstance.PrivateSendInMapAfter(20, "msg 0 The Duel will begin in 10 seconds.");
                    mapinstance.PrivateSendInMapAfter(25, "ta_s 1");
