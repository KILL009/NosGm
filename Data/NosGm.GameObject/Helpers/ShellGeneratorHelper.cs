...
namespace NosGm.GameObject.Helpers
{
    public class ShellGeneratorHelper
    {
        ...
        public int PerfumeFromItemLevelAndShellRarity(short level, byte rare)
        {
            ...
            else if (level <= 123) //Armadura C28
            {
                switch (rare)
                {
                    case 1:
            ...
            else if (level <= 143) //Armadura C48
            {
                switch (rare)
                {
                    case 1:
        ...
        public int PerfumeGoldAmountFromLevel(short level)
        {
            ...
            if (level < 90) return 17500;

            return level < 99 ? 20000 : 100000;
        }
