...
using NosGm.Core.Networking.Communication.Scs.Client.Tcp;
using NosGm.Core.Networking.Communication.Scs.Server;
using NosGm.Core.Networking.Communication.Scs.Server.Tcp;
using System;
using System.Net;
using System.Net.Sockets;

namespace NosGm.Core.Networking.Communication.Scs.Communication.EndPoints.Tcp
{
    /// <summary>
