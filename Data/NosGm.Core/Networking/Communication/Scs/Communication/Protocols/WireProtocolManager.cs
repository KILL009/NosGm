using NosGm.Core.Networking.Communication.Scs.Communication.Protocols.BinarySerialization;

namespace NosGm.Core.Networking.Communication.Scs.Communication.Protocols
{
    /// <summary>
